...
function RegistroContent() {
    ...
    const candidateName =
        profile?.name && profile.name !== "Candidato"
            ? profile.name
            : "la campaña";
    const firstName =
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
            ...
            >
                ...
                <div className="text-center mb-6">
                    ...
                    <span className="eyebrow-red block mb-1">
                        Campaña {candidateName}
                    </span>
                    <h1 className="font-serif text-2xl font-bold text-gray-900">
                        Únete al movimiento
                    </h1>
                    <p className="text-sm text-gray-500 mt-1">
                        Regístrate y sé parte del plan de gobierno de{" "}
                        {firstName}. Gana puntos por participar.
                    </p>
                </div>
